# LAB211 Assignment - Fruit Shop Management System
...
|------|------|-------------|
| 1 | - Code Design<br>- Create Fruit | - Student should create Fruit class with some its attributes: Fruit Id, Fruit Name, Price, Quantity and Origin<br>- Using ArrayList to store the Fruit. |
| 2 | - Shopping | - Using ArrayList to store items that customer bought fruit and using HashTable to store order of customer.<br>Eg: `hashTable.set(<customer name>,<list of items bought>)` |
| 3 | - Shopping | |
| 4 | - View order | |
| 5 | - Review program | |
...
// Store orders: Customer name -> List of items bought
